...
namespace io{
    class UVC_Runnable{
        private:
            ...
            /// Thread group to hold the thread running the UVC_Runnable::runnable
        ...
        public:
            ...
            /**
             * \brief Destroy the UVC_Runnable object. Ensures all threads are stopped properly via UVC_Runnable::stop
             */
            ~UVC_Runnable(void); 
