...
bool
io::IsUserHome_Runnable::isUserHome(std::string ip)
{
    ...
    try {
        ...
        std::cout
          << "\033[1;44mIsUserHome_Runnable heartbeat\033[0m\tA standard "
...
void
io::IsUserHome_Runnable::runnable(const boost::system::error_code& err,
...
void
io::IsUserHome_Runnable::thread_runner(void)
{
    boost::asio::io_context io_context;
    boost::function<void(void)> callback(
      boost::bind(&io::IsUserHome_Runnable::isUserHome, this, HOME_DEVICE_IP));
...
void
io::IsUserHome_Runnable::start(void)
{
...
void
io::IsUserHome_Runnable::stop(void)
{
    this->thread_group.interrupt_all();
}

void
io::IsUserHome_Runnable::attach(void)
{
